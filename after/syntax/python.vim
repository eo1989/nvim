" Remove the keywords, re-add them later below. Use silent in case the group doesnt exist.
...
" XXX least specific cases at the top, since the match rules seem to be cumulative


" " Include the space after “not” – if present – so that “not a” becomes “¬a” also, don't hide “not” behind  ‘¬’ if it is after “is ”
...
" from zchee/.nvim - https://github.com/zchee/.nvim/blob/main/after/syntax/python.vim
