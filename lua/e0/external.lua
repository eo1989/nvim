...
local highlights_loaded, H = pcall(require, "e0.highlights")
local fn = vim.fn
...
function M.tmux.set_statusline(reset)
  ...
  local bg = require("e0.highlights").get_hl(hl, "bg")
...
function M.kitty.set_background()
  ...
  if vim.env.KITTY_LISTEN_ON then
    local bg = require("e0.highlights").get_hl("MsgArea", "bg")
...
function M.kitty.clear_background()
  ...
  if vim.env.KITTY_LISTEN_ON then
    local bg = require("e0.highlights").get_hl("Normal", "bg")
...
function M.title_string()
  ...
  return fmt("%s #[fg=%s]%s ", dir, require("e0.highlights").get_hl(hl, "fg"), icon)
end
