...
function M.tmux.set_statusline(reset)
  ...
  local bg = require("e0.highlights").hl_value(hl, "bg")
...
function M.kitty.set_background()
  if vim.env.KITTY_LISTEN_ON then
    local bg = require("e0.highlights").hl_value("MsgArea", "bg")
...
function M.kitty.clear_background()
  if vim.env.KITTY_LISTEN_ON then
    local bg = require("e0.highlights").hl_value("Normal", "bg")
...
function M.title_string()
  ...
  return fmt("%s #[fg=%s]%s ", dir, require("e0.highlights").hl_value(hl, "fg"), icon)
end
